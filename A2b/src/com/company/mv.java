...
public class mv extends command{
     ...
     */
    public mv(ArrayList<String> cmd1, ArrayList<String> cmd2) {
        this.splited1 = cmd1;
        this.splited2 = cmd2;
    ...
    public int renaming(){
        ...
        if (!oldName.equals(newName)){
            parent.rename(oldName, newName, parent.getList());
        }
    ...
    public void callFilesystem() {
        ...
        ArrayList<fileSystem> contentlist= pointer1.getParent().getList();
        if (pointer1.remove(pointer1, contentlist) == -1) {
            System.out.println("Invalided argument - remove not working, try again");
            return;
        }
        pointer2.addContent(pointer1);
    }
}
